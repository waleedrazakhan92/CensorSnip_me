...
if __name__ == "__main__":
    main(path_input=path_input,path_model=path_model,path_results=path_results,class_confidence_dict=class_confidence_dict,
         ...
         pred_batch=1,write_encoding=write_encoding,skip_sound=skip_sound)
